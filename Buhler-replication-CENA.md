...
| **D16** | 2026-08-25 | **Coolidge-tube precedent + CRT calibration added (`Buhler-research.md` §14.4).** Brown's founding observation was made on an X-ray tube — a device whose purpose is directional electron emission. Electron-beam thrust calibrates at F/P = 2.1×10⁻⁸ N/W; the patent's 237 µN would need ~11 kW by that route. **D9's X-ray finding is regrounded as a legislated 1968 consumer hazard rather than a novel one** — CRT leaded glass exists because of it. Free-flyback HV supply noted as a BOM alternative and *not recommended* (pulsed output, worse shock profile than a bench supply). |
